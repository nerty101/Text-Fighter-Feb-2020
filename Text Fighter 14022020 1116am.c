...
printf("     It was an exciting contest!\n");///error found here suspicious 12022020
...
diceF = (rand() % 37 + diflev + diceR) + 1; //42 40 39 38
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 47 + diflev) + 1; //54 52 51 50 48
}
...
if ((emagsup > 0) && ((diceN > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && ((spatt2 < 1) && (supspatt2 < 1) && (hypsp2 < 1)))
{
