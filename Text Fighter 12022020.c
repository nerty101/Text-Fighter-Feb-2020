...
int spatt = 0, supspatt = 0, hypsp = 0, enspcomb1 = 0, enspcomb2 = 0, enspcomb3 = 0, enemspcombC = 0, c = 0, d = 0, e = 0, f = 0, g = 0, cpmag = 0, cpmag2 = 0, windup, c2 = 0;
int spmag = 0, spmag2 = 0, magsp = 0, magsp2 = 0, normag = 0, magsp3 = 0, sumag2 = 0, sumag = 0, magsp7 = 0, consecvic5 = 0, consecvic7 = 0, spctrbon7 = 0;
int diflev = 0, posdef = 0, posmag = 0, posbon = 0, bonchn = 0, bonchn2 = 0, cpusp = 0, cpusp2 = 0, consecvic4 = 0, spctrbon3 = 0, ultsp = 0, ultsp3 = 0, ultsp4 = 0;
...
int mspatt3 = 0, emgspcom3 = 0, hypsp2 = 0, spatt2 = 0, supspatt2 = 0, emgspcom4 = 0, mspatt4 = 0, new0 = 1, bonrec5 = 0, dmg = 0, dmg2 = 1, a = 0, b = 0;
...
printf("     CPU HP at %d\n", enemyhp);
///++ultsp; taken out, organic better 210120
consecvic2 = 1;
spctrbon = 1;
++cpusp;
++cpusp2;
...
if ((enspcomb3 == 1) && (playerhp < 1) && ((diceZ > 5) || (diceZ < 6)) && (f > 0) && (e > 0) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && ((diceC > 47) && (diceB == 5)) && (emagsup < 1) && (emagsup5 < 1)  && (emagsup6 < 1))
{
...
if (enemspcombC != 1)
{
if ((enspcomb1 == 1) && (playerhp < 1) && ((diceZ > 5) || (diceZ < 6)) && (f < 1) && (e > 0) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && (emagsup < 1) && (emagsup5 < 1) && (emagsup6 < 1))
{
...
if ((enspcomb2 == 1) && (playerhp < 1) && ((diceZ > 5) || (diceZ < 6)) && (f > 0) && (e < 1) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceC > 47) && (diceB == 5)) && (emagsup < 1) && (emagsup5 < 1) && (emagsup6 < 1))
{
...
if ((enspcomb2 == 1) && (playerhp < 1) && ((diceZ > 5) || (diceZ < 6)) && (f > 0) && (e > 0) && (d < 1) && ((diceC > 47) && (diceB == 5)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && (emagsup < 1) && (emagsup5 < 1) && (emagsup6 < 1))
{
...
{
diceM = ((rand() % 60 + 1) + (diflev + 3));// diceM was at 60 then 56 has to be at 60///*************DIFLEV INCREMENT MUST BE AT 3!!! AT 2 MAGIC SUPER WILL NOT ACTIVATE ON + 30 DIFLEV!!!!!!!!!!!!!
if (diceR == 1)
{
diceR = (rand() % 8) + 1;//6
if (diceR == 1)
...
if ((emgspcom == 1) && (playerhp < 1) && (emgspcom5 != 1) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6) && (diceM > 40)))
{
...
if ((emgspcom5 == 1) && (playerhp < 1) && (emgspcom != 1) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6) && (diceM > 40)))
{
...
if ((emagsup5 > 0) && ((diceP > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && ((spatt2 < 1) && (supspatt2 < 1) && (hypsp2 < 1)))
{//
...
if ((emgspcom4 == 1) && (playerhp < 1) && ((diceN > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0)))
{
...
if (diceQ == 2)
printf("     IT'S AN INCREDIBLE MAGIC WIN!\n\n");
if (diceQ == 3)
printf("     AND A STUNNING MAGIC VICTORY!\n\n");
}
if ((emgspcom3 == 1) && (playerhp < 1) && ((diceP > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0) && (mspatt5 > 0)))
{
...
if (diceQ == 2)
printf("     THE DEFINITIVE CPU MAGIC WIN!\n\n");
if (diceQ == 3)
...
{
diceQ = (rand() % 64) + 1;//12 24 32 38 40
...
diceQ1 = (rand() % 68) + 1;//14 16 32 38 42 44 48 70
if (((diceQ > 15) && (diceQ1 < 18) && (diceQ1 != 12) && (diceQ1 > 1)) || ((diceQ1 > 1) && (diceQ1 < 18) && (diceQ1 != 12) && ((diceQ == 5) || (diceQ == 13))  && (ctr < 9)) || ((diceQ1 > 1) && (diceQ1 < 18) && (diceQ1 != 12) && (diceQ == 12) && (ctr < 5)))
printf("\n");
if ((diceQ > 15) && (diceQ1 == 1) && (diceE <= 20) && (diceF <= 29) && (diceC <= 47) && (diceM <= 40))
printf("\n");
if ((diceQ > 15) && (diceQ1 == 12) && (windup < 1))
printf("\n");
...
if ((diceQ1 == 12) && (windup < 1))
printf("     Be determined to win!\n\n");
if (diceQ1 == 13)
